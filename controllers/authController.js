...
const { ACCESS_TOKEN, REFRESH_TOKEN, SECURE_DEV, SAME_SITE_DEV, SECURE_PROD, SAME_SITE_PROD } = process.env;
...
exports.postLogin = async (req, res) => {
  ...
  try {
    ...
    res.cookie("refreshCookie", refreshToken, {
      httpOnly: true,
      secure: SECURE_PROD, // true in production (only send over https)
      sameSite: SAME_SITE_PROD, // None in prod, Lax in dev
    });
